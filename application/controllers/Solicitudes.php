...
class Solicitudes extends CI_Controller
{
    ...
    public function guardar()
    {
        ...
        $codigoSolicitud = "Express-" . $this->generarCodigo(8) . "-2021";
        $dpi = $_SESSION["dpi"];
        ...
        if (empty($usuario)) {
            ...
            header("Location: http://127.0.0.1:8888/Express/index.php/solicitudes/nuevo?response=1");
            die();
        }
        // si no se cumple la funcíón if, se quedará en la misma url y no mostrar ningun mensaje y los datos no se guardaran
        else {
            header("Location: http://127.0.0.1:8888/Express/index.php/solicitudes");
            die();
        }
    }
    ...
    public function asignar()
    {
        ...
        // El header es para poder decirle que si se ejecuta lo anterior cambia la url y le agrega la variable respose 1 que
        // es el mensaje de exito que se insertaron los datos
        header("Location: http://127.0.0.1:8888/Express/index.php/solicitudes?response=1");
        die();
