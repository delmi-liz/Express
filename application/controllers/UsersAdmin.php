...
class UsersAdmin extends CI_Controller
{
  ...
  public function guardar()
  {
    ...
    if (empty($usuario)) {
      header("Location: http://127.0.0.1:8888/Express/index.php/usersAdmin/nuevo");
      die();
    } else {
      ...
      header("Location: http://127.0.0.1:8888/Express/index.php/usersAdmin/nuevo?response=1");
      die();
    }
  }
}
