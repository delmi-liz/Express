...
class Users extends CI_Controller
{
  ...
  public function guardardos()
  {
    ...
    if (empty($usuario)) {
      header("Location: http://127.0.0.1:8888/Express");
      die();
    } else {
      ...
      header("Location: http://127.0.0.1:8888/Express/index.php/users/nuevos?response=1");
      die();
    }
  }
  ...
  public function guardar()
  {
    ...
    // si se cumple la funicón para poder guardar los datos, mandamos los respectivos  datos
    if (empty($usuario)) {
      header("Location: http://127.0.0.1:8888/Express/index.php/users/nuevo");
      die();
    } else {
      ...
      // El header es para poder decirle que si se ejecuta lo anterior cambia la url y le agrega la variable respose 1 que
      // es el mensaje de exito que se insertaron los datos
      header("Location: http://127.0.0.1:8888/Express/index.php/users/nuevo?response=1");
      die();
    }
  }
  ...
  public function updatedata()
  {
    ...
    header("Location: http://127.0.0.1:8888/Express/index.php/users?response=1");
    die();
  }
